...
//        jedis.rename("hello","has");
//        print(1,jedis.get("has"));
...
//        print(10, jedis.linsert(listName, BinaryClient.LIST_POSITION.BEFORE, "a4", "244"));
//        print(10, jedis.linsert(listName, BinaryClient.LIST_POSITION.BEFORE, "a4", "2s4"));
...
//        jedis.hsetnx(userKey, "scholl", "sss");
//        jedis.hsetnx(userKey, "name", "asd");//存在不改写
...
//        print(29, jedis.srandmember(likeKey1,2));//随机抽奖
...
//        jedis.zincrby(rankKey, 2, "Luc");//若不存在，则直接新添加
...
//        print(39, jedis.zrevrank(rankKey, "Luc"));
//
//        String setKey = "zset";
...
//        print(40, jedis.zlexcount(setKey, "-", "+"));//正、负无穷
//        print(41, jedis.zlexcount(setKey, "(b", "[d"));//数学集合
//        print(42, jedis.zlexcount(setKey, "[b", "[d"));
//        jedis.zrem(setKey, "b");
//        print(43, jedis.zrange(setKey, 0, 10));
//        jedis.zremrangeByLex(setKey, "(c", "+");//字典序删除
...
//        user.setSalt("salt");
//        user.setId(1);
//        print(46, JSONObject.toJSONString(user));//序列化
